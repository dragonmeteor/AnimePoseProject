...
class CountBonesInVmdVpdList {
    public static void main(String[] args) {
        if (args.length < 2) {
            print("Usage: java yumyai.poseest.mmd.motion.CountBonesInVmdVpdList <list-file> <output-file>")
            System.exit(0)
        }
        ...
        new File(args[0]).withReader { f ->
            ...
            while (line != null) {
                try {
                    ...
                    ArrayList<String> bones = PrintVmdVpdBones.getBoneList(fileName)
